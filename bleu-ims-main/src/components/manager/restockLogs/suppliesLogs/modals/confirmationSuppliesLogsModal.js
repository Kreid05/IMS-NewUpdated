...
function ConfirmationSuppliesLogsModal({ visible, onConfirm, onCancel, formData }) {
        ...
        <div className="confirmation-modal-overlay">
            <div className="confirmation-modal-content">
                <div className="confirmation-modal-header">
                    <h3>Confirm Supplies Log Record</h3>
                </div>
...
export default ConfirmationSuppliesLogsModal;
